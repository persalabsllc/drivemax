        ...
        <div className="container content-split content-split-wide">
          <div>
            <div className="contact-cards">
              ...
              <div className="info-card"><div className="info-card-icon"><Mail aria-hidden="true" /></div><h2>Email us</h2><p><a href="mailto:sales@drivemaxusedcars.com">sales@drivemaxusedcars.com</a></p><p>Please contact us before visiting while reopening work is underway.</p></div>
            </div>
